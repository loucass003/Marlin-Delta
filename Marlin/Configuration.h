...
#define DELTA
  ...
  #define DELTA_HEIGHT 306.75             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 105.0              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_XYZ_STEPS_PER_UNIT 80.01994
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 198.55 }  // default steps per unit for Kossel (GT2, 20 tooth)
